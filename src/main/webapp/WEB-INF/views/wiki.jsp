...
<!-- 			Меню -->
				...
				<ul>
					<li><a href="#pr">Торговое Имущество</a></li>
					<ul>
                        ...
                        <li><a href="#pr.ll">Земельные участки</a></li>
					</ul>
					
					<li><a href="#sp">Служебное Имущество</a></li>
					<ul>
						<li><a href="#sp.lm">Магазин лицензий</a></li>
						<ul>
							<li><a href="#sp.lm.mc">Постройка и улучшение</a></li>
							<li><a href="#sp.lm.wg">Что дает повышение уровня</a></li>
							<li><a href="#sp.lm.st">Время продажи лицензий</a></li>
						</ul>
					</ul>
					...
					<ul>
						...
						<li><a href="#lo.ac">Статьи выигрыша (обычные)</a></li>
							<ul>
                                ...
                                <li><a href="lo.aс.ll">Земельные участки</a></li>
							</ul>
					</ul>
...
<!-- 			Имущество -->
			...
			<div class="text">
				<p>Имущество является одним из основных источников прибыли. Оно располагается на <a href="#pr.ll">земельных участках.</a>
				<p>У имущества есть общие характеристики (минимальная и	максимальная прибыль, срок полезного 
                  использования...подробности ниже).</p>
...
<!-- 			Имущество.Строительство -->
			...
			<div class="text">
				...
				тоже (уровень 1 открыт изначально и каждые ${licTerms[0]} дней срок такой лицензии продолжается 
				еще на ${licTerms[0]} дней). 
				...
				<p><b>Уровни, цена покупки, сроки действия:</b>
				 <table border=1px solid style="text-align: center; margin: auto; border-collapse: collapse;">
					...
					<tr><td>1</td><td>${licPrices[0]}</td><td>${licTerms[0]}</td></tr>
					<tr><td>2</td><td>${licPrices[1]}</td><td>${licTerms[1]}</td></tr>
					<tr><td>3</td><td>${licPrices[2]}</td><td>${licTerms[2]}</td></tr>
					<tr><td>4</td><td>${licPrices[3]}</td><td>${licTerms[3]}</td></tr>
				</table>
...
<!--            Земельные участки -->
                <div id="pr.ll" class="sp_point fs2">Земельные участки</div>
                <div class="text">
                  <p>Имущество и строительные проекты располагаются на земельных участках. Земельные участки располагаются в разных
                  районах города. Их можно купить или выиграть в лотерею. Чем лучше район, тем дороже участок.
                  <p>Каждый последующий участок дороже предыдущего. На цену влияет, как район, так и универсальные коэффициенты.
                </div>
      
<!-- 			Служебное имущество -->
			<div id="sp" class="sp_point fs1">Служебное имущество</div>
			
			<div id="sp.lm" class="sp_point fs2">Магазин лицензий</div>
			<div class="text">
				<p>Магазин лицензий относится к служебному имуществу и служит для продажи лицензий, выигранных в лотерею. 
			</div>
			<div id="sp.lm.mc" class="sp_point fs3">Постройка и улучшение магазина</div>
			<div class="text">
				<p>После постройки уровень Магазина лицензий = <b>1</b> – это тоже самое, что и повышение уровня этого магазина к <b>1</b>. 
				После постройки продавать лицензии еще нельзя. Почему? Читайте ниже!
				...
				<ul>
					...
					<li>Иметь определенное количество доминантности, а именно: 
					<b>[базовая ставка (1000)] * [уровень, к которому повышается] + [ставка за уровень (500)]</b>.</li>
					<li>Иметь <b>[уровень, к которому повышается]</b> шт. Магазинов канцтоваров c характеристиками 
					(район – <b>гетто</b>, уровень – <b>10</b>, процент износа <b>< 100</b>).</li>
				</ul>
			</div>
			<div id="sp.lm.wg" class="sp_point fs3">Что дает повышение уровня Магазина лицензий?</div>
			<div class="text">
				<p> После постройки уровень = <b>1</b>, продавать еще нельзя, т.к. нет лицензий уровня <b>1</b>.
				<p> Уровни <b>2-4</b> – каждый уровень дает возможность продавать каждый следующий уровень лицензий, к примеру:
				<table border=1px solid style="text-align: center; margin: auto; border-collapse: collapse;">
					<tr><td><b>Уровень магазина</b></td><td><b>Уровень лицензий</b></td></tr>
					<tr><td>2</td><td>2</td></tr>
					<tr><td>3</td><td>3</td></tr>
					<tr><td>4</td><td>4</td></tr>
				</table>
				<p>Начиная с <b>5</b>-го уровня – каждый уровень дает прибавку <b>10%</b> к прибыли за продажу лицензий. Это значит, что, 
				если у вас Магазин лицензий <b>6</b>-го уровня, то прибавка будет <b>20%</b>. Продавая лицензии на 
				<b>100 000&tridot;</b> вы получите <b>20 000&tridot;</b> сверху (за уровень).
			</div>
			<div id="sp.lm.st" class="sp_point fs3">Время продажи лицензий</div>
			<div class="text">
				<p> Лицензии продаются партиями. Одна партия может включать 1 - ∞ количество лицензий, но только лишь 
				определенного уровня. Каждый уровень лицензий продается разное количество часов. После продажи деньги зачисляются 
				на счет автоматически. Время продажи:
				<table border=1px solid style="text-align: center; margin: auto; border-collapse: collapse;">
					<tr><td><b>Уровень лицензий</b></td><td><b>Время, часов</b></td></tr>
					<tr><td>2</td><td>${hoursToSellLic2}</td></tr>
					<tr><td>3</td><td>${hoursToSellLic3}</td></tr>
					<tr><td>4</td><td>${hoursToSellLic4}</td></tr>
				</table>
			</div>
...
<!-- 			Баланс -->
			...
			<div class="text">
			<p>Каждые 30 дней, в зависимости от размера баланса, пользователю на сумму баланса
            ...
            <div id="ba.bo" class="sp_point fs2">Бонус</div>
            <div class="text">
            <p>Приблизительно каждые 5 минут можно получить бонус. Один бонус равняется одному лотерейному билету. Выигрыши, 
            соответственно, такие же, как и в <a href="#lo">лотерею</a>.
            </div>
...
<!-- 			Лотерея -->
			...
			<p>Максимальное суточное количество розыгрышей в лотерею = <b>${lotteryGamesLimit}</b>.
			...
			<div id="lo.ap" class="sp_point fs2">Статьи выигрыша (плюшки)</div>
				<div class="text">
					...
					<p>Выигранные лицензии сожно продать в <a href="#sp.lm">Магазине лицензий</a>.
				...
				<div class="text">
                    ...
                    <div id="lo.aс.ll" class="sp_point fs3">Земельные участки</div>
                    <p><a href="#pr.ll">Земельные участки</a> в разных <a href="#pr.ma.ca">районах</a> города.
				</div>
			</div>
