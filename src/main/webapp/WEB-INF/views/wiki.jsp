...
<t:template>
	<div class="content">
		...
		<h1 align="center">wiki</h1>
			...
			<div class="text">
				<p>Рынок имущества является глобальным в игре. Это значит, что если один игрок купил какое-либо имущество, то становится его 
				единственным владельцем и другим игрокам это имущество уже не будет доступно.</p>
				<p>Имущество на рынке появляется каждые <b> ${frp_min} - ${frp_max} </b> дней.
				...
				<p>Вид имущества, который появится, тоже зависит от рандома. Но одни виды, как правило, с худшими характеристиками, приоритетней за другие.
				...
				<p>Если не хватает денег (но баланс > 0) или низкая состоятельность для покупки конкретного имущества - будет показана страница ошибок и 
				  максимальная сумма, которая доступна для покупки имущества.
				<p>Если же баланс < 0, в таком случае вообще запрещено покупать имущество.
				
				<div id="pr.ma.se" class="sp_point fs3">Продажа</div>
				<p>Имущество можно продавать. 
