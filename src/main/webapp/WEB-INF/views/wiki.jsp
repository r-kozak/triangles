			...
			<div class="text">
				...
				<p><b>Типы строителей и скорость:</b>
					<ul>
						...
						<li>Украинцы: <b>${builders[1]}%</b></li>
						<li>Немцы: <b>${builders[2]}%</b></li>
					</ul>
				...
				тоже (уровень 1 открыт изначально и каждые ${licTerm[1]} недель срок такой лицензии продолжается 
				еще на ${licTerm[1]} недель). 
				...
				<p><b>Уровни, цена покупки, сроки действия:</b>
				 <table border=1px solid style="text-align: center; margin: auto; border-collapse: collapse;">
					<tr><td><b>Уровень</b></td><td><b>Цена лицензии, &tridot;</b></td><td><b>Срок действия, недель</b></td></tr>
				...
				<p>Например, сегодня 01.09.2015. У вас есть лицензия уровня 2, вы ее купили неделю назад. Она 
				заканчивается 20.10.2015 (через 7 недель). Вы хотите купить лицензию уровня 4, чтобы строить в районе Центр.
				<p>Если вы купить лицензию уровня 4, срок действия ее станет 2 недели, закончится она 15.09.2015 и тогда
...
<!-- 			Доминантность -->
    		...
    		<ol>
	    		<li>1 очко на 500&tridot;.</li>
	   			<li>10 очков на 5000&tridot;.</li>
	  			</ol>
    		<p>При этом у вас снимется 1 или 10 очков доминантности и на баланс тут же будет 
    		   начислено 500&tridot; или 5000&tridot;.
			...
			<p>Кроме всех вышеописанных функций, очки доминантности каждый день приносят бесплатные лотерейные билеты.
			   ...
			   начислились билеты. 
   			<p>За 10 очков доминантности начисляется 1 билет.
