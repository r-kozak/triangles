 ...
 * 
 * usefulLife - срок полезного использования, в 2 раза больше периода окупаемости, недель profit - прибыль в день {min,
 * max} cashCapacity - вместимость кассы на разных уровнях, {на ур 0, на ур 1, ...} paybackPeriod - период окупаемости
 * {min, max}, недель purchasePrice - цена покупки {min, max} buildTime - время постройки (при скорости 100%), дней
